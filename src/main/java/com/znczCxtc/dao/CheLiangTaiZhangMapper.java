...
public interface CheLiangTaiZhangMapper {
	...
	public int queryForInt(@Param("ddh") String ddh, @Param("cph") String cph, @Param("ddztId") Integer ddztId, @Param("ddztMcList") List<String> ddztMcList, 
			@Param("jcsjs") String jcsjs, @Param("jcsje") String jcsje, @Param("ccsjs") String ccsjs, @Param("ccsje") String ccsje);

	public List<CheLiangTaiZhang> queryList(@Param("ddh") String ddh, @Param("cph") String cph, @Param("ddztId") Integer ddztId, @Param("ddztMcList") List<String> ddztMcList, 
