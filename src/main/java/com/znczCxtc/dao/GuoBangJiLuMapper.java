...
public interface GuoBangJiLuMapper {
	...
	List<GuoBangJiLu> queryList(@Param("ddh") String ddh, @Param("cyclCph") String cyclCph, @Param("gbsjks") String gbsjks, @Param("gbsjjs") String gbsjjs, 
	...
	int deleteByDdId(@Param("gblx") Integer gblx, @Param("ddId") Long ddId);

	int getCountByDdId(@Param("gblx") Integer gblx, @Param("ddId") Long ddId);
}
